 ...
 **/
public class DealPlatformCoupon {

    private static String FILE_TEST_ORDER = "/file/july/testJulyBaseData.txt";

    private static String FILE_ORDER = "/file/july/JulyBaseData2.txt";

    private static String FILE_PLATFORM_DISCOUNT_COUPON = "/file/july/orderDetailCouponDiscountInfo.txt";

    private static String FILE_COUPON_INFO = "/file/july/JulyplatfromCouponInfo.txt";
